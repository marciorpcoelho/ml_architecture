...
from level_1_c_data_modelling import apv_stock_evolution_calculation
...
def data_acquistion(options_info):
    ...
    start = time.time()
    current_date, _ = time_tags(format_date='%d_%m_%y')
