...
#     'WHERE Client_Id = 3  and Parts_Included = 1 AND NLR_Code = \'701\' and PSE_Code = ' + str(PSE_Code) + ' and LEFT(Part_Ref, 2) in (\'MN\', \'BM\') ' \
...
#     'WHERE NLR_Code = \'701\'  AND Parts_Included=1 and PSE_Code = ' + str(PSE_Code) + ' and LEFT(Part_Ref, 2) in (\'MN\', \'BM\') ' \
#     ' union all ' \
#     'SELECT Movement_Date, ' \
#         'PLR_Document,' \
#         'Quantity, ' \
...
#     'WHERE NLR_Code = \'701\' and Parts_Included=1 and PSE_Code = ' + str(PSE_Code) + ' and LEFT(Part_Ref, 2) in (\'MN\', \'BM\')  and Warehouse_Code <> -1 ' \
#     'union all ' \
#     'SELECT Part_Ref,' \
#         'Part_Desc,' \
...
#     'WHERE NLR_Code = \'701\' and PSE_Code = ' + str(PSE_Code) + ' and LEFT(Part_Ref, 2) in (\'MN\', \'BM\')'
